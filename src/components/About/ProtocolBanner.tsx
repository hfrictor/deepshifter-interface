...
const DARK_MODE_GRADIENT = 'radial-gradient(101.8% 4091.31% at 0% 0%, #4673FA 0%, #004aad 100%)'
...
const Banner = styled.div<{ isDarkMode: boolean }>`
  ...
  background: ${({ isDarkMode }) =>
    isDarkMode
      ...
      : `url(${meshSrc}), linear-gradient(93.06deg, #0093ad 2.66%, #004aad 98.99%);`};
...
const ProtocolBanner = () => {
  ...
  return (
    <Banner isDarkMode={isDarkMode}>
      <TextContainer>
        <HeaderText>Powered by the DeepShifter Protocol</HeaderText>
        <DescriptionText>
